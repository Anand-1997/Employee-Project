...
public class ProjectServiceImpl implements ProjectService {
	...
	/*
	 * This method validates the given date of project with the given format and
	 * returns the date.
	 */
	...
	public void assignEmployee(int assignProjectId, int[] employeeid) {
		projectDao.assignEmployee(assignProjectId,employeeid);
	...
	public List<Employee> getEmployees() {
		...
		return projectDao.getEmployees();
	}
}
