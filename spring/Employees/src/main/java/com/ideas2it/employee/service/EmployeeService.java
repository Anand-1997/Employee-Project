...
public interface EmployeeService {
	...
	/*
	 * This method is used to pass employee details required for the insert
	 * operation.
	 */
	Employee setEmployeeDetails(String firstName, String lastName, String phoneNumber, String email, String dateOfBirth)
			throws Exception;

	/*
	 * This method is used to pass address details required for the insert
	 * operation.
	 */
	 ...
	 */
	/*
	 * This method validates the given date of birth with the given format and
	 * return date of birth
	 */
	String validatedateOfBirth(String DOB) throws Exception;

	/*
	 * This method validates the given Email with the given format and return Email
	 */
	String validateEmail(String email) throws Exception;

	/*
	 * This method validates the given Phone Number with the given format and return
	 * Phone Number
	 */
	...
	/*
	 * public void insertEmployee(Employee employee, Address currentAddress, Address
	 * permanentAddress);
	 */
